CREATE TABLE `emails` (
  ...
  `is_sent` tinyint(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Whether the message has been already delivered or not. Do not specify this field when manually inserting emails.',
  `is_cancelled` tinyint(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Whether this email has been cancelled or not. Do not specify this field when manually inserting.',
  `is_blocked` tinyint(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Whether this email has been blocked or not. Do not specify this field when manually inserting.',
